...
export default function Home() {
  ...
  const changeHandler = (e) => {
    ...
    switch (parseInt(e.target.value)) {
      case 1:
        ...
        slider.classList.remove("accent-orange-500");
        slider.classList.remove("accent-yellow-500");
        exp.innerText = "Really Bad";
        break;
      case 2:
        ...
        react4.style.display = "none";
        react5.style.display = "none";
        slider.classList.add("accent-orange-500");
        slider.classList.remove("accent-green-500");
        slider.classList.remove("accent-yellow-500");
      ...
      case 3:
        ...
        react5.style.display = "none";
        slider.classList.remove("accent-red-500");
        slider.classList.add("accent-yellow-500");
        slider.classList.remove("accent-green-500");
        slider.classList.remove("accent-orange-500");
        slider.classList.remove("accent-blue-500");

        exp.innerText = "Intermediate";
        break;
      case 4:
        react3.style.display = "none";
        react1.style.display = "none";
  ...
  return (
    <div className="py-12 px-4">
      <div className=" mx-auto container lg:max-w-[356px] md:max-w-[720px] max-w-[343px] py-8 px-8 bg-slate-800 shadow rounded-md">
        <p className="text-base font-semibold leading-normal text-center text-white">
        ...
        <div
          id="react2"
          style={{ display: "none" }}
          className="border  mx-auto rounded-full w-[64px] h-[64px] border-orange-500 relative mt-6 mb-6"
        >
          <svg
            className="absolute  top-[11px] left-[11px]"
            width={40}
        ...
        <div
          id="react3"
          style={{ display: "none" }}
          className="border  mx-auto rounded-full w-[64px] h-[64px] border-yellow-400 relative mt-6 mb-6"
        >
          <svg
            className="absolute  top-[11px] left-[11px]"
            width={40}
        ...
        <div
          id="react4"
          style={{ display: "block" }}
          className="border  mx-auto rounded-full w-[64px] h-[64px] border-green-500 relative mt-6 mb-6"
        >
          <svg
            className="absolute  top-[11px] left-[11px]"
            width={40}
        ...
        <p className="text-sm leading-none text-center text-white">
          <span id="exp">Really Bad</span> Experience
        </p>
