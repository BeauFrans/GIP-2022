...
export default function Sidebar() {
  ...
  return (
    <div className="flex h-screen max-w-xs flex-col justify-between border-r border-slate-600 bg-slate-800">
      <div className="px-4 py-6">
        <div className="border-b border-slate-600 w-full" />
        <div className="py-2 flex flex-col justify-center items-center">
          <p className="text-sm font-semibold text-gray-200">{mail}</p>{" "}
          <p className="text-sm font-bold text-white">{rol.toUpperCase()}</p>{" "}
        </div>
        <div className="border-b border-slate-600 w-full" />
        <nav className="mt-6 flex flex-col space-y-1">
          ...
          <details className="group">
            <summary className="flex cursor-pointer items-center rounded-lg px-4 py-2 text-gray-200 hover:bg-slate-600  bg-slate-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
